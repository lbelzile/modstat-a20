...
class fumeuse hypertension irrit prematures / param=glm expb;
model faible(ref="0")=fumeuse hypertension irrit prematures mmere / clodds=pl;
run;

/* Exercice:
1) Qu'arrive-t-il si vous changez la référence en ref="1"
pour modéliser la probabilité d'avoir un bébé d'un poids normal?
2) interprétez l'effet des variables explicatives sur la cote
