...
Inscrivez-vous sur *SAS OnDemand for Academics* et créez un compte sur [https://odamid.oda.sas.com](https://odamid.oda.sas.com) en sélectionnant l'option *Register for an account*.

Après avoir créé un compte utilisateur, suivez ces étapes:

- Inscrivez vous sur le centre de contrôle (*Control Center*) à [https://odamid.oda.sas.com](https://odamid.oda.sas.com).
...
![Localisation du fichier `autoexec`](../files/images/SASonDemand_autoexec.png)
![Modifications du fichier `autoexec`](../files/images/SASonDemand_autoexec_2.png)
...
```
Vous pouvez également télécharger les données ([fichier `.zip`](https://raw.githubusercontent.com/lbelzile/modstat/main/files/introSAS/Intro_SAS_data.zip)) et créer votre propre bibliothèque. Pour ce faire, créez un dossier contenant les bases de données (extension `.sas7bdat`) et utilisez les commandes suivantes: 

![Création d'une nouvelle bibliothèque](../files/images/SASonDemand_nouvelle_biblio.png)


![Sélection du répertoire](../files/images/SASonDemand_nouvelle_biblio_2.png)
...
- [Diapositives](https://raw.githubusercontent.com/lbelzile/modstat/main/files/introSAS/MATH60619_SAS_intro.pdf)
- [Code](https://raw.githubusercontent.com/lbelzile/modstat/main/files/introSAS/MATH60619_SAS_intro.sas)
- [Exercices](https://raw.githubusercontent.com/lbelzile/modstat/main/files/introSAS/MATH60619_SASexercices.pdf)
- [Exercices (code SAS)](https://raw.githubusercontent.com/lbelzile/modstat/main/files/introSAS/MATH60619_SASexercices.sas)
- [Jeux de données (zip)](https://raw.githubusercontent.com/lbelzile/modstat/main/files/introSAS/Intro_SAS_data.zip)
