*Inférence et analyse statistique;
* Laboratoire SAS;
...
proc freq data=intro_ex1;
 tables age; 
 ods output Freq.Table1.OneWayFreqs=dist_age; /* Le tableau de fréquence se nomme 
       Freq.Table1.OneWayFreqs . Nous le
       conservons dans le jeu de données
       dist_age */
run;
