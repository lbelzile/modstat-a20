...
exdat$`Code SAS` <- c(paste0("[code SAS](", linkgithub, codesas, ")"),rep("", length.out = 7-length(codesas)))
exdat$`Code R` <- c(paste0("[code R](", linkgithub, coder, ")"),rep("", length.out = 7-length(coder)))
