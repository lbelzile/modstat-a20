...
Vous êtes responsables uniquement pour le contenu des vidéos, sauf indication contraire. Si je réfère à un outil, une statistique ou un concept qui n'est pas présenté dans les diapositives, veuillez lire la section des notes de cours.
...
- [Atelier: données longitudinales](https://raw.githubusercontent.com/lbelzile/modstat/master/atelier/60604_longitudinal.txt)
