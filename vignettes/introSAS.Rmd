...
Si vous accédez à **SAS** onDemand, vous pouvez créer la bibliothèque contenant toutes les données utilisées en classe en mode lecture seule automatiquement en modifiant le fichier `autoexec` à l'aide de la commande suivante: `LIBNAME modstat "~/my_shared_file_links/u41148888/modstat" access=readonly;`
